...
**Solution (design, tumhara choice):** Sequential — normal → backup → chunk scan. Backup sirf tab jab gap hai,
...
### Problem 8 (naya) — Backup me over-eager MATCH (false positive) ka risk
...
Formula: `fps = clamp(floor(900 / clipSeconds), 5, 24)`. Sab 250K TPM ke andar.
